...
If you met me outside of Cyprus, you probably know me as Phibo. In any case, check out this brief [clip from the sitcom *Friends*](https://www.youtube.com/watch?v=f63sK_KMovE), if you want to make sure that you remember my name or that you pronounce it correctly.
...
I am currently a Post-Doctoral Associate at the [School of Physical Therapy, University of Western Ontario](https://www.uwo.ca/fhs/pt/index.html), conducting my research at the [Gray Centre for Mobility and Activity](https://www.sjhc.london.on.ca/gray-centre) at Parkwood Institute.

I obtained my BSc in **Psychology**, from Frederick University in 2019, where I graduated as the **Valedictorian**. My graduation address can be [found here](https://www.youtube.com/watch?v=TCqeY3iD7RA) (in Greek). In 2023, I received my PhD from the [Department of Rehabilitation Sciences](https://www.cut.ac.cy/faculties/hsc/reh/staff/postresearcher/pp.phylactou/) at the Cyprus University of Technology, where I worked in the [Brain and Cognitive Science Lab](https://www.nkonstantinou.com).
...
You can check out the [Projects](https://phivph.com/projects.html) section to find out the details of my work!

Or, have a look at the [list of my publications](https://phivph.com/publications.html), if you don't already have an overwhelming *"to read"* list!
<br>
<br>
...
I have delivered various science communication workshops to scientists, for numerous organisations such as the Cyprus Research and Innovation Foundation. You can check out this [youtube video](https://youtu.be/aT99vnwat8U) as an example from an online workshop.

Another example of my passion for science communication, is found in my [TEDx talk](https://www.ted.com/talks/phivos_phylactou_beyond_what_our_eyes_perceive), which was given in my hometown, Limassol, as part of a TEDx youth event.

A more recent example can be found in [this research sprint](https://www.youtube.com/watch?v=KE_2W-Qj22k), where I present my main work as a postdoc at Western, in just 2 minutes.
<br>
<br>
...
<img align="center" src="/files/skills_funny.png">
